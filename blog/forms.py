...
class InstaForm(forms.Form):
    ...
    Image_numbers= forms.CharField(required=True,widget=forms.TextInput(attrs={'class':'form-control' , 'autocomplete': 'off', 'type': 'number', 'max':'500','pattern':'[0-9]+', 'title':'Enter only numbers'}))
